...
#Lisiting of dictionary representing the code of the geoloction in google trends  
...
#Scrapping over the past 12 months         
...
#Editng fourth page of the Scrapping tool 
